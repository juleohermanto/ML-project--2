    ...
    if uploaded_file is not None:
        ...
        if 'review_text' not in df.columns:
            ...
            if st.button("Run Batch Inference", type="primary"):
                ...
                # Show Analytics if we have results
                if results:
                    ...
                    if not neg_df.empty:
                        ...
                        # Remove 'General' from chart if we want to focus on specific business problems
                    ...
                    # 3. Filterable Priority Data Table
                    ...
                    if not priority_df.empty:
                        ...
                        # Fallback to all negative reviews
